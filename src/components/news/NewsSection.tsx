    ...
    <section className="bg-cream-dark py-12">
      <div className="max-w-[1400px] mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <h2 className="font-headline text-2xl font-bold text-gray-900">Latest News</h2>
          <a
            href="#news"
            className="flex items-center gap-1 text-cricket-green font-semibold text-sm hover:gap-2 transition-all"
          >
            See all news <ChevronRightIcon size={16} />
          </a>
        </div>
